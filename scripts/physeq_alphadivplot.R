...
geom_jitter(size=1,alpha=.8,aes(color=!!group)) + scale_x_discrete(guide = guide_axis(angle = 90)) + ggtitle(paste0("Alpha-diversity, by ",group)) + scale_color_viridis_d(option="H",begin=0.1,end=0.9) 
