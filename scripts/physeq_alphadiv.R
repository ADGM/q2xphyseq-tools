...
#measures=c("Observed","Chao1","Shannon","Fisher","Simpson","InvSimpson")
physeq_alphadiv=function(physeq,measures) {
...
alpha.vals=estimate_richness(ps.rarefied, measures=measures)
